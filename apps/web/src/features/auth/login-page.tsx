...
export function LoginPage() {
  ...
  return (
    <form onSubmit={handleSubmit} className="w-full max-w-md rounded-3xl bg-white p-8 shadow-xl">
      <div>
        <p className="text-sm font-semibold uppercase tracking-[0.35em] text-brand-700">Acesso</p>
        <h2 className="mt-3 text-3xl font-semibold text-slate-950">Entre na sua conta</h2>
        <p className="mt-2 text-sm text-slate-500">
          Use a conta criada no cadastro para acessar o painel.
        </p>
      </div>
